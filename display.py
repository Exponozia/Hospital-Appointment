...
class Application:
    def __init__(self,master):
        ...
        #Button to change appointments

        self.change = Button(self.master, text="Next Patient", width=25, height=2, bg='steelblue',command = self.func)
        self.change.place(x=500, y=600)

        #empty text Labels to Later confiq

        self.n = Label(master, text='1', font=('arial 200 bold'))
        self.n.place(x=500, y=100)

        self.pname = Label(master,text="Tom Marks ", font=('arial 80 bold'))
